<template>
    <div>
        ...
        <div class="body">
            <el-table :data="tableData" style="width: 89%" class="table">
                ...
                <el-table-column prop="operate" label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        <el-button size="small" type="info" @click="showdia_chg(scope.row)">修改
                        </el-button>
                ...
                <el-table-column width="120" align="center">
                    <template slot="header">
                        <el-button icon="el-icon-plus" size="small" type="info" @click="showdia_add()">添加商品
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>

            <el-dialog title="添加商品" :visible.sync="dia_add" width="30%">
            ...
            <el-dialog title="修改商品" :visible.sync="dia_chg" width="30%">
                <el-form ref="chg_form" :model="chg_form" label-width="100px">
            ...
            <el-dialog title="删除商品" :visible.sync="dia_dlt" width="30%">
                <div>
                    确定删除此商品吗？
                </div>
                <div style="text-align: center;">
