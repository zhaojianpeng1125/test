    ...
    <div>
        ...
        <div class="body">
            <el-table :data="tableData" style="width: 100%" class="table" border>
                ...
                <el-table-column prop="shop_name" label="超市" width="100" align="center">
                </el-table-column>
                ...
                <el-table-column prop="orderway" label="下单方式" width="100" align="center">
                </el-table-column>
                <el-table-column prop="cons_phone" label="收货人电话" width="200" align="center">
                </el-table-column>
                <el-table-column prop="cons_name" label="收货人姓名" width="100" align="center">
                </el-table-column>
                <el-table-column prop="cons_addre" label="收货地址" width="200" align="center">
                </el-table-column>
            ...
            <el-dialog title="派发订单" :visible.sync="dialog" width="30%">
                <el-form ref="form" :model="form" label-width="120px">
                    ...
                    <el-form-item label="选择送货员：" prop="">
                        <el-select v-model="form.dispatcher_id" placeholder="请选择送货员编号">
