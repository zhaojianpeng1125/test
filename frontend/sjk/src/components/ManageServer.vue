    ...
    <div>
        ...
        <div class="body">
            <el-table :data="tableData" style="width: 89%" class="table">
                <el-table-column prop="service_id" label="配货员编号" width="200" align="center">
                </el-table-column>
                ...
                <el-table-column width="120" align="center">
                    <template slot="header">
                        <el-button icon="el-icon-plus" size="small" type="info" @click="showdia_add()">添加配货员
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>

            <el-dialog title="添加配货员" :visible.sync="dia_add" width="30%">
                <el-form ref="add_form" :model="add_form" label-width="120px" :rules="add_form_rules">
                    <el-form-item label="配货员编号：" prop="service_id">
                        <el-input v-model="add_form.service_id"></el-input>
                    </el-form-item>
                    <el-form-item label="配货员姓名：" prop="service_name">
                        <el-input v-model="add_form.service_name"></el-input>
                    </el-form-item>
                    
                </el-form>
                <div style="text-align: center;">
                    <el-button type="info" @click="addserver()">
                        添加
                    </el-button>
                </div>
            </el-dialog>
            ...
            <el-dialog title="解雇配货员" :visible.sync="dia_dlt" width="30%">
                <div>
                    确定解雇此配货员吗？
                </div>
                <div style="text-align: center;">
